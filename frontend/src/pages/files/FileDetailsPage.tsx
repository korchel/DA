      ...
      <Card.Body className="flex justify-between gap-3 flex-wrap">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between">
            <ActionButton actionType="download" title={t('download')} onClick={(event) => handleDownload(event, id)} />
            <ActionButton actionType="overview" title={t('see')} onClick={(event) => handleOverview(event, id)} />
          </div>
        </div>
      </Card.Body>
      <Card.Footer>
